...
class LangGraphEconomicAgent:
    ...
    def _create_workflow(self) -> StateGraph:
        """Create the LangGraph economic analysis workflow"""
        workflow = StateGraph(EconomicAnalysisState)
        
        # Add nodes for 8-step economic analysis
        workflow.add_node("data_collection", self._collect_economic_data)
        workflow.add_node("growth_analysis", self._analyze_economic_growth)
        workflow.add_node("inflation_analysis", self._analyze_inflation_trends)
        workflow.add_node("employment_analysis", self._analyze_employment_situation)
        workflow.add_node("monetary_policy_analysis", self._analyze_monetary_policy)
        workflow.add_node("market_sentiment_analysis", self._analyze_market_sentiment)
        ...
        workflow.add_edge("data_collection", "growth_analysis")
        workflow.add_edge("growth_analysis", "inflation_analysis")
        workflow.add_edge("inflation_analysis", "employment_analysis")
        workflow.add_edge("employment_analysis", "monetary_policy_analysis")
        workflow.add_edge("monetary_policy_analysis", "market_sentiment_analysis")
        workflow.add_edge("market_sentiment_analysis", "generate_insights")
