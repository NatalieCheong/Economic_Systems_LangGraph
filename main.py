...
from config import Config, EconomicConfig
...
Examples:
    ...
    python main.py --analysis-type industry_performance --period 5y
    
    # Tech industry specific analysis
    python main.py --analysis-type tech_industry_performance --period 1y
    
    # Healthcare industry analysis
    python main.py --analysis-type healthcare_industry_performance --period 2y
    
    # Finance industry analysis
    python main.py --analysis-type finance_industry_performance --period 1y
    
    # Energy industry analysis
    python main.py --analysis-type energy_industry_performance --period 2y
    
    # Supply chain analysis
    python main.py --analysis-type supply_chain_analysis --period 1y
    
    # Market trend analysis
    python main.py --analysis-type market_trend --period 2y
        """
    )
    
    parser.add_argument(
        '--analysis-type',
        choices=['gdp_focus', 'inflation_focus', 'market_trend', 'industry_performance', 
                 'tech_industry_performance', 'healthcare_industry_performance', 
                 'finance_industry_performance', 'energy_industry_performance', 
                 'supply_chain_performance'],
        default='gdp_focus',
        help='Type of economic analysis to perform (default: gdp_focus)'
    )
...
def run_interactive_mode(app: EconomicAnalysisApp):
    ...
    while True:
        ...
        print("5. Tech Industry Performance Analysis")
        print("6. Healthcare Industry Analysis")
        print("7. Finance Industry Analysis")
        print("8. Energy Industry Analysis")
        print("9. Supply Chain Analysis")
        print("10. Policy Brief Generation")
        print("11. Investor-Focused Analysis")
        print("12. Custom Analysis")
        print("13. Exit")
        ...
        try:
            ...
            if choice == "1":
                ...
                print(f"\n🏦 Running tech industry performance analysis...")
                app.quick_economic_analysis("tech_industry_performance", period)
                
            elif choice == "6":
                period = input("Enter period (1y/2y/5y): ").strip() or "2y"
                print(f"\n🏥 Running healthcare industry analysis...")
                app.quick_economic_analysis("healthcare_industry_performance", period)
                
            elif choice == "7":
                period = input("Enter period (1y/2y/5y): ").strip() or "1y"
                print(f"\n💰 Running finance industry analysis...")
                app.quick_economic_analysis("finance_industry_performance", period)
                
            elif choice == "8":
                period = input("Enter period (1y/2y/5y): ").strip() or "2y"
                print(f"\n⚡ Running energy industry analysis...")
                app.quick_economic_analysis("energy_industry_performance", period)
                
            elif choice == "9":
                period = input("Enter period (1y/2y/5y): ").strip() or "1y"
                print(f"\n📦 Running supply chain analysis...")
                app.quick_economic_analysis("supply_chain_analysis", period)
                ...
                analysis_type = input("Analysis type (comprehensive/gdp_focus/inflation_focus/industry_performance/market_trend/tech_industry_performance/healthcare_industry_performance/finance_industry_performance/energy_industry_performance/supply_chain_analysis): ").strip() or "comprehensive"
